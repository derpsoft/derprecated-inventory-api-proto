namespace Derprecated.Api.Test.Core.Handlers
{
    ...
    public class ShopifyHandler
    {
        ...
        [Test]
        [TestOf(typeof (Api.Handlers.ShopifyHandler))]
        [Author(Constants.Authors.James)]
        ...
        public void UpdateProduct_ValidProduct_Updates()
        {
            ...
            Assert.DoesNotThrow(() => result = handler.Update(update));
            Assert.That(result.BodyHtml.Equals(update.BodyHtml, StringComparison.CurrentCultureIgnoreCase));
        }
        ...
        public void UpdateVariant_ValidVariant_Updates()
        {
            ...
            Assert.DoesNotThrow(() => result = handler.Update(update));
            Assert.That(result.Price.Equals(update.Price, StringComparison.CurrentCultureIgnoreCase));
        }
    }
}
